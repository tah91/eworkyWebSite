        ...
        public string AvailableString
        {
            get
            {
                if (AvailableNow)
                    ...
                    return string.Format(System.Threading.Thread.CurrentThread.CurrentCulture.DateTimeFormat, "{0} : {1:d}", Worki.Resources.Models.Rental.Rental.Availability, AvailableDate.Value);
                else
                    return string.Empty;
            }
        }
